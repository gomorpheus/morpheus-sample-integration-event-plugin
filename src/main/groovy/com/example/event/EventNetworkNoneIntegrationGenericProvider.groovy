...
@Slf4j
class EventNetworkNoneIntegrationGenericProvider extends AbstractGenericIntegrationProvider implements GenericIntegrationProvider.EventSubscriberFacet<NetworkEvent> {

	public static final String PROVIDER_CODE = 'morpheus-event-none-sample.generic'
	public static final String PROVIDER_NAME = 'Event Network None Integration Generic Provider'

	protected MorpheusContext context
	protected Plugin plugin

	EventNetworkNoneIntegrationGenericProvider(Plugin plugin, MorpheusContext context) {
		this.plugin = plugin
