...
@Slf4j
class EventNetworkManyAllIntegrationGenericProvider extends AbstractGenericIntegrationProvider implements GenericIntegrationProvider.EventSubscriberFacet<NetworkEvent> {

	public static final String PROVIDER_CODE = 'morpheus-event-many-all-sample.generic'
	public static final String PROVIDER_NAME = 'Event Network Many All Integration Generic Provider'

	protected MorpheusContext context
	protected Plugin plugin

	EventNetworkManyAllIntegrationGenericProvider(Plugin plugin, MorpheusContext context) {
		this.plugin = plugin
