...
@Slf4j
class EventClusterManyClusterIntegrationGenericProvider extends AbstractGenericIntegrationProvider implements GenericIntegrationProvider.EventSubscriberFacet<ClusterEvent> {

	public static final String PROVIDER_CODE = 'morpheus-event-cluster-many-cluster-sample.generic'
	public static final String PROVIDER_NAME = 'Event Cluster Many Cluster Integration Generic Provider'

	protected MorpheusContext context
	protected Plugin plugin

	EventClusterManyClusterIntegrationGenericProvider(Plugin plugin, MorpheusContext context) {
		this.plugin = plugin
	...
	List<EventType> getSupportedEventTypes() {
		return [ClusterEvent.ClusterEventType.ADD_WORKER, ClusterEvent.ClusterEventType.REMOVE_WORKER]
	}
