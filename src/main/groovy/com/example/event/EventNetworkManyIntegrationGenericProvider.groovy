...
@Slf4j
class EventNetworkManyIntegrationGenericProvider extends AbstractGenericIntegrationProvider implements GenericIntegrationProvider.EventSubscriberFacet<NetworkEvent> {

	public static final String PROVIDER_CODE = 'morpheus-event-many-sample.generic'
	public static final String PROVIDER_NAME = 'Event Network Many Integration Generic Provider'

	protected MorpheusContext context
	protected Plugin plugin

	EventNetworkManyIntegrationGenericProvider(Plugin plugin, MorpheusContext context) {
		this.plugin = plugin
