...
@Slf4j
class EventClusterManyCloudIntegrationGenericProvider extends AbstractGenericIntegrationProvider implements GenericIntegrationProvider.EventSubscriberFacet<ClusterEvent> {

	public static final String PROVIDER_CODE = 'morpheus-event-cluster-many-cloud-sample.generic'
	public static final String PROVIDER_NAME = 'Event Cluster Many Cloud Integration Generic Provider'

	protected MorpheusContext context
	protected Plugin plugin

	EventClusterManyCloudIntegrationGenericProvider(Plugin plugin, MorpheusContext context) {
		this.plugin = plugin
	...
	List<EventType> getSupportedEventTypes() {
		return [ClusterEvent.ClusterEventType.CREATE, ClusterEvent.ClusterEventType.UPDATE, ClusterEvent.ClusterEventType.DELETE]
	}
