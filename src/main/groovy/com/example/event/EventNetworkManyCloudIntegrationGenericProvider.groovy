...
@Slf4j
class EventNetworkManyCloudIntegrationGenericProvider extends AbstractGenericIntegrationProvider implements GenericIntegrationProvider.EventSubscriberFacet<NetworkEvent> {

	public static final String PROVIDER_CODE = 'morpheus-event-many-cloud-sample.generic'
	public static final String PROVIDER_NAME = 'Event Network Many Cloud Integration Generic Provider'

	protected MorpheusContext context
	protected Plugin plugin

	EventNetworkManyCloudIntegrationGenericProvider(Plugin plugin, MorpheusContext context) {
		this.plugin = plugin
